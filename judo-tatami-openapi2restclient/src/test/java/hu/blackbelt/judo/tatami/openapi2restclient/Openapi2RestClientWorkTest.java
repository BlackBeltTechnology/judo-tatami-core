...
public class Openapi2RestClientWorkTest {
	...
	Openapi2RestClientWork openapi2RestClientWork;
	...
	void setUp() throws Exception {
		...
		OpenapiModel openapiModel = OpenapiModel.buildOpenapiModel().name(NORTHWIND).build();
		...
		openapi2RestClientWork = new Openapi2RestClientWork(transformationContext, "dart2-api", ImmutableMap.of("enablePostProcessFile", "true"));
	}

	@Test
	void testSimpleWorkflow() {
		WorkFlow workflow = aNewSequentialFlow().execute(openapi2RestClientWork).build();
