...
public class TrackInfoServiceImplTest {
    ...
    public void testBuildGraph() {
        ...
        Resource level1Model1R = rootModelRs.createResource(level1Model1Uri);
        ...
        Resource level1Model2R = rootModelRs.createResource(level1Model2Uri);
        ...
        Resource level1Model3R = rootModelRs.createResource(level1Model3Uri);
        ...
        Resource level2Model1R = rootModelRs.createResource(level2Model1Uri);
        ...
        Resource level2Model2R = rootModelRs.createResource(level2Model2Uri);
        ...
        Resource level3Model1R = rootModelRs.createResource(level3Model1Uri);
        ...
        TrackInfoTest level1_to_level2model2 = TrackInfoTest.builder()
                ...
                .trace(ImmutableMap.of(level1Model1O1, ImmutableList.of(level2Model1O1)))
                .build();
