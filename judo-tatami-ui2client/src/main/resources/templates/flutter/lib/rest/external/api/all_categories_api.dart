...
class AllCategoriesApi {
  final AllCategoriesApiDelegate apiDelegate;
  AllCategoriesApi(ApiClient apiClient)
      : assert(apiClient != null),
        apiDelegate = AllCategoriesApiDelegate(apiClient);
...
class AllCategoriesApiDelegate {
  final ApiClient apiClient;

  AllCategoriesApiDelegate(this.apiClient) : assert(apiClient != null);
