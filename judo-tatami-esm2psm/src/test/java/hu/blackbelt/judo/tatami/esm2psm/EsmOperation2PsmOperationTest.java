...
public class EsmOperation2PsmOperationTest {
    ...
    void CreateBoundOperationTest() throws Exception {
        ...
        BoundOperation boundOperation = newBoundOperationBuilder().withName("boundOperation")
                ...
                .withFaults(newParameterBuilder().withName("faultParameter").withLower(1).withUpper(1).withTarget(targetMappedTransferObjectType).build())
        ...
        //--------- Bound Operation
        final Optional<hu.blackbelt.judo.meta.psm.service.BoundOperation> psmBoundOperation = allPsm(hu.blackbelt.judo.meta.psm.service.BoundOperation.class).filter(boundOp -> "boundOperation".equals(boundOp.getName())).findAny();
        ...
        assertTrue(psmBoundOperation.get().getInput().getCardinality().getLower() == 1 && psmBoundOperation.get().getInput().getCardinality().getUpper() == 1);
        assertTrue(psmBoundOperation.get().getOutput().getCardinality().getLower() == 1 && psmBoundOperation.get().getOutput().getCardinality().getUpper() == 1);

        //--------- Parameter
        final Optional<hu.blackbelt.judo.meta.psm.service.MappedTransferObjectType> psmTargetMappedTransferObject = allPsm(hu.blackbelt.judo.meta.psm.service.MappedTransferObjectType.class).filter(mappedTOT -> "targetMappedTransferObjectType".equals(mappedTOT.getName())).findAny();
        assertTrue(psmTargetMappedTransferObject.isPresent());

        //input
        final Optional<hu.blackbelt.judo.meta.psm.service.Parameter> psmInputParameter = allPsm(hu.blackbelt.judo.meta.psm.service.Parameter.class).filter(param -> "inputParameter".equals(param.getName())).findAny();
        ...
        //output
        final Optional<hu.blackbelt.judo.meta.psm.service.Parameter> psmOutputParameter = allPsm(hu.blackbelt.judo.meta.psm.service.Parameter.class).filter(param -> "outputParameter".equals(param.getName())).findAny();
        ...
        //fault
        final Optional<hu.blackbelt.judo.meta.psm.service.Parameter> psmFaultParameter = allPsm(hu.blackbelt.judo.meta.psm.service.Parameter.class).filter(param -> "faultParameter".equals(param.getName())).findAny();
